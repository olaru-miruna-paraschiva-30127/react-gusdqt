...
style={{width:'90%',height:'55px',justifyContent:'space-between',
   ...
   borderRadius:'20px',
   boxShadow:''
   }}><div style={{display:'flex'}}><CiTextAlignJustify/>&nbsp;&nbsp;<div>Duration</div></div></button></div>
   <br/>
   <div style={{
   display:'flex',
...
style={{width:'90%',height:'55px',justifyContent:'space-between',
   ...
   borderRadius:'20px',
   boxShadow:''
   }}><div style={{display:'flex'}}><CiTextAlignJustify/>&nbsp;&nbsp;<div>Timeline</div></div></button></div>
   <br/>
   <div style={{
   display:'flex',
...
style={{width:'90%',height:'55px',justifyContent:'space-between',
   ...
   borderRadius:'20px',
   boxShadow:''
   }}><div style={{display:'flex'}}><CiTextAlignJustify/>&nbsp;&nbsp;<div>Deliverables</div></div></button></div>
   <br/>
   <div style={{
   display:'flex',
